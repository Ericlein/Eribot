...
class RemediationClient:
    ...
    def _test_connection(self) -> bool:
        ...
        try:
            ...
            if response.status_code == 200:
                ...
                self.logger.warning(
                    f"Remediation service returned status: " f"{response.status_code}"
                )
                return False
        ...
        try:
            ...
            for url in urls_to_try:
                try:
                    ...
                    if e.response.status_code == 404 and url == urls_to_try[0]:
    ...
    def get_available_actions(self) -> List[str]:
        ...
        try:
            ...
            return ["high_cpu", "high_disk", "high_memory", "service_restart"]
