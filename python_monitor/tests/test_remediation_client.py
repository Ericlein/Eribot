...
class TestRemediationClientUnit:
    ...
    @pytest.mark.unit
    def test_remediation_client_creation_health_check_failure(self, mock_requests_session, remediation_config):
    ...
    @pytest.mark.unit
    def test_remediation_client_creation_health_check_exception(self, mock_requests_session, remediation_config):
    ...
    @pytest.mark.unit
    def test_trigger_remediation_success_legacy_api(self, mock_requests_session, remediation_config):
    ...
    @pytest.mark.unit
    def test_trigger_remediation_success_non_json_response(self, mock_requests_session, remediation_config):
    ...
    def test_trigger_remediation_connection_error(self, mock_requests_session, remediation_config):
        ...
        mock_requests_session.get.return_value = mock_health_response
        mock_requests_session.post.side_effect = requests.exceptions.ConnectionError("Connection refused")
        
        client = RemediationClient(remediation_config)
        
        with pytest.raises(ServiceUnavailableError, match="Could not connect to remediation service"):
            client.trigger_remediation("high_cpu")
    ...
    def test_trigger_remediation_http_error_400(self, mock_requests_session, remediation_config):
        ...
        mock_requests_session.get.return_value = mock_health_response
        mock_requests_session.post.side_effect = requests.exceptions.HTTPError(response=mock_error_response)
    ...
    def test_trigger_remediation_http_error_503(self, mock_requests_session, remediation_config):
        ...
        with pytest.raises(ServiceUnavailableError, match="Remediation service temporarily unavailable"):
            client.trigger_remediation("high_cpu")

    @pytest.mark.unit
    def test_trigger_remediation_unexpected_exception(self, mock_requests_session, remediation_config):
    ...
    @pytest.mark.unit
    def test_get_available_actions_fallback_to_legacy(self, mock_requests_session, remediation_config):
    ...
    @pytest.mark.unit
    def test_get_available_actions_fallback_to_defaults(self, mock_requests_session, remediation_config):
    ...
    @pytest.mark.unit
    def test_get_available_actions_request_exception(self, mock_requests_session, remediation_config):
    ...
    @pytest.mark.unit
    def test_trigger_remediation_http_error_no_response(self, mock_requests_session, remediation_config):
    ...
    @pytest.mark.unit 
    def test_trigger_remediation_with_empty_context(self, mock_requests_session, remediation_config):
    ...
    @pytest.mark.unit
    def test_trigger_remediation_all_endpoints_fail(self, mock_requests_session, remediation_config):
    ...
    @pytest.mark.unit
    def test_trigger_remediation_json_decode_error_with_success_response(self, mock_requests_session, remediation_config):
    ...
    @pytest.mark.unit 
    def test_trigger_remediation_legacy_endpoint_first_try(self, mock_requests_session, remediation_config):
    ...
    @pytest.mark.unit
    def test_get_available_actions_missing_actions_key(self, mock_requests_session, remediation_config):
    ...
    @pytest.mark.unit
    def test_get_service_status_request_exception_on_second_call(self, mock_requests_session, remediation_config):
        ...
        mock_requests_session.get.side_effect = [
            ...
            requests.exceptions.RequestException("Network error on status call")  # Status call fails
        ]
    ...
    @pytest.mark.unit
    def test_get_available_actions_request_exception_on_second_call(self, mock_requests_session, remediation_config):
        ...
        mock_requests_session.get.side_effect = [
            mock_health_response,  # Health check succeeds
            requests.exceptions.RequestException("Network error on actions call")  # Actions call fails
        ]
