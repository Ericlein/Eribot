...
class TestIntegrationUnit:
    ...
    def test_end_to_end_monitoring_unit(self, mock_remediation_client, mock_slack_client, app_config):
    ...
    @patch('core.monitor.SlackClient')
    @patch('core.monitor.RemediationClient')
    def test_monitoring_with_high_thresholds_unit(self, mock_remediation_client, mock_slack_client, app_config):
    ...
    @patch('core.monitor.RemediationClient')
    @patch('time.sleep')
    def test_monitoring_loop_unit(self, mock_sleep, mock_remediation_client, mock_slack_client, app_config):
...
class TestIntegration:
    ...
    @patch('core.monitor.SlackClient')
    @patch('core.monitor.RemediationClient')
    def test_monitoring_with_high_thresholds(self, mock_remediation_client, mock_slack_client, app_config):
